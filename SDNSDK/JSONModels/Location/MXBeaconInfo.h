...
/// See MSC3489 for more details https://github.com/sdn-org/sdn-spec-proposals/blob/matthew/location-streaming/proposals/3489-location-streaming.md
...
/// Create the `MXBeaconInfo` object from a SDN m.beacon_info event.
