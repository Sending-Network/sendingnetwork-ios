...
class MXBackgroundStore: NSObject, MXStore {
    ...
    func storeHasReachedNodePaginationEnd(forRoom roomId: String, andValue value: Bool) {
    }
    
    func hasReachedNodePaginationEnd(forRoom roomId: String) -> Bool {
        return true
    }
    ...
    var nodeWellknown: MXWellKnown?
    
    func storeNodeWellknown(_ nodeWellknown: MXWellKnown) {
    }

    var nodeCapabilities: MXCapabilities?
    func storeNodeCapabilities(_ nodeCapabilities: MXCapabilities) {
    }

    var supportedSDNVersions: MXSDNVersions?
    func storeSupportedSDNVersions(_ supportedSDNVersions: MXSDNVersions) {
    }
