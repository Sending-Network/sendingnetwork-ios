...
- (NSUInteger)limit
{
    NSUInteger limit = 10;  // Basic default value used by nodes
...
{
    BOOL lazyLoadMembers = NO; // Basic default value used by nodes
...
{
    BOOL unreadThreadNotifications = NO; // Basic default value used by nodes
