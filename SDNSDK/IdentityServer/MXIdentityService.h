...
/**
 `MXIdentityService` manages requests to SDN identity servers and abstract identity server REST client token and version management.
 */
...
/**
 ...
 @param nodeRestClient The node REST client.
 
 @return a MXIdentityService instance.
 */
- (instancetype)initWithIdentityServer:(NSString *)identityServer accessToken:(nullable NSString*)accessToken andNodeRestClient:(MXRestClient*)nodeRestClient NS_REFINED_FOR_SWIFT;
...
/**
 Retrieve user sdn ids from a list of 3rd party ids.
