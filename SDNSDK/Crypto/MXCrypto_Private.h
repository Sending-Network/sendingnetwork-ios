...
/**
  The instance used to make requests to the node.
 */
...
/**
 Retrieve the number of one time keys published on the node.
...
/**
 Generate and publish enough one time keys on the node.
 
 @param keyCount the number of keys currently available on the node.
...
/**
 ...
 @param backUp YES to back up them to the node.
 @param success A block object called when the operation succeeds.
