...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self)
    {
        ...
        self.hasReachedNodePaginationEnd = [aDecoder decodeBoolForKey:@"hasReachedNodePaginationEnd"];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeBool:self.hasReachedNodePaginationEnd forKey:@"hasReachedNodePaginationEnd"];
