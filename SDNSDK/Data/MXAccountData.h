...
/**
 ...
 It is fully or partially updated on node `/sync` response.
...
/**
 ...
 @param accountData as sent by the node. Same format as self.accountData.
 */
...
/**
 The account data as sent by the node /sync response.
 */
