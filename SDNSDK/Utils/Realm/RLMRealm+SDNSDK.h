...
@interface RLMRealm (SDNSDK)

/**
 Same method with `RLMRealm(SDNSDK) transactionWithName:block:error` without error handling.
 @see -[RLMRealm(SDNSDK) transactionWithName:block:error]
 */
