...
/**
 ...
 It may require a request to the node if the client has not fetched yet all
...
/**
 ...
 HTTP request to the node is requested.
 ...
 */
- (id)initWithRoomId:(NSString*)roomId andSDNSession:(MXSession*)mxSession;
...
/**
 ...
 @return the new instance.
 */
- (id)initWithRoomId:(NSString *)roomId sdnSession:(MXSession *)mxSession andStore:(id<MXStore>)store;
...
/**
 ...
 @param roomId the id of the room.
 @param sdnSession the session to use.
 @return the new instance.
 */
...
/**
 ...
 This will indicate to the node that the user has read this event.
 Set YES the boolean updateReadMarker to let know the node the user has read up to this event.
...
/**
 ...
 This is will indicate to the node that the user has read all the events.
 */
- (void)markAllAsRead;
...
/**
 This will indicate to the node that the user has read up to this event.
...
/**
 ...
 @param forceDownload YES to fetch data from the node. NO to retrieve stored data.
