...
/**
 ...
 See https://github.com/uhoreg/sdn-doc/blob/ssss/proposals/1946-secure_server-side_storage.md
 */
 ...
 */
- (instancetype)initWithSDNSession:(MXSession *)mxSession  processingQueue:(dispatch_queue_t)processingQueue;
