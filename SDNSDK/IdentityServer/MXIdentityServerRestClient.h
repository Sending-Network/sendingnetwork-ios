...
/**
 `MXIdentityServerRestClient` makes requests to SDN identity servers.
 */
...
/**
 Register with an identity server using the OpenID token from the user's node (v2 API).

 @param openIdToken The OpenID token from an node.
...
/**
 Retrieve a user sdn id from a 3rd party id (v1 API).
 
 @param address the id of the user in the 3rd party system.
 @param medium the 3rd party system (ex: "email").
 
 @param success A block object called when the operation succeeds. It provides the SDN user id.
...
/**
 Retrieve user sdn ids from a list of 3rd party ids (v1 API).
...
/**
 Retrieve user sdn ids from a list of 3rd party ids (v2 API). Require informations from `hashDetailsWithSuccess:failure` request.
