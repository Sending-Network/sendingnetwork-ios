...
- (BOOL)session:(MXSession *)session updateRoomSummary:(MXRoomSummary *)summary withStateEvents:(NSArray<MXEvent *> *)stateEvents roomState:(MXRoomState*)roomState
{
    ...
    {
        // The server does not send yet room summary for invited rooms (https://github.com/sdn-org/sdn-doc/issues/1679)
        ...
        // We need more information from the node to solve it. The issue above should help to fix it
...
- (BOOL)updateSummaryDisplayname:(MXRoomSummary *)summary session:(MXSession *)session withServerRoomSummary:(MXRoomSyncSummary *)serverRoomSummary roomState:(MXRoomState *)roomState excludingUserIDs:(NSArray<NSString *> *)excludedUserIDs
{
    ...
    // Compute a display name according to algorithm provided by SDN room summaries
    // (https://github.com/sdn-org/sdn-doc/issues/688)
    ...
    else
    {
        ...
        // Use SDN room summaries and heroes
        ...
        {
            NSArray *otherMembers = [self sortedOtherMembersInRoomState:roomState withSDNSession:session];
...
/**
 ...
 One known reason is https://github.com/sdn-org/synapse/issues/4194.
...
- (BOOL)updateSummaryAvatar:(MXRoomSummary *)summary session:(MXSession *)session withServerRoomSummary:(MXRoomSyncSummary *)serverRoomSummary roomState:(MXRoomState *)roomState excludingUserIDs:(NSArray<NSString *> *)excludedUserIDs
{
    ...
    else if (summary.isDirect)
    {
        ...
        {
            NSArray<MXRoomMember*> *otherMembers = [self sortedOtherMembersInRoomState:roomState withSDNSession:session];
...
- (NSArray<MXRoomMember*> *)sortedOtherMembersInRoomState:(MXRoomState*)roomState withSDNSession:(MXSession *)session
{
