...
/// MXRoomType identifies the type of room as decribed in MSC1840 (see https://github.com/sdn-org/sdn-doc/pull/1840).
...
static MXRoomTypeString const MXRoomTypeStringRoomMSC1840 = @"org.sdn.msc1840.messaging";
static MXRoomTypeString const MXRoomTypeStringRoom = @"m.message";
static MXRoomTypeString const MXRoomTypeStringSpace = @"m.space";
static MXRoomTypeString const MXRoomTypeStringVideo = @"io.sendingnetwork.video";
