...
/**
 ...
 Media upload is based on sdn content repository. It requires a sdn session.
 */
@interface MXMediaManager : NSObject

/**
 Create an instance based on a node url. This node URL is required to resolve
 the SDN Content URI (in the form of "mxc://...").
...
/**
 The node URL.
 */
@property (nonatomic, readonly) NSString *nodeURL;
...
/**
 Resolve a SDN media content URI (in the form of "mxc://...") into an HTTP URL.
 
 @param mxcContentURI the SDN content URI to resolve.
 @return the SDN content HTTP URL. nil if the SDN content URI is invalid.
 */
- (NSString*)urlOfContent:(NSString*)mxcContentURI;

/**
 Get the suitable HTTP URL of a thumbnail image from a SDN media content according to the destined view size.

 @param mxcContentURI the SDN content URI to resolve.
 @param viewSize in points, it will be converted in pixels by considering screen scale.
 @param thumbnailingMethod the method the SDN content repository must use to generate the thumbnail.
 @return the thumbnail HTTP URL. The provided URI is returned if it is not a valid SDN content URI.
 */
...
/**
 Get the unique download identifier for a SDN Content URI, consider a potential cache folder to handle
 several downloads in different cache areas.
 
 @param mxContentURI the SDN Content URI (mxc://...).
 @param folder cache folder to use (may be nil). kMXMediaManagerDefaultCacheFolder is used by default.
 @return the download identifier. nil if the SDN Content URI is invalid.
 */
+ (NSString*)downloadIdForSDNContentURI:(NSString*)mxContentURI
                                  inFolder:(NSString*)folder;

/**
 Get the unique download identifier for a thumbnail downloaded from on the SDN Content URI,
...
/**
 Download data from the provided SDN Content (MXC) URI (in the form of "mxc://...").
...
/**
 Download thumbnail data from the provided SDN Content (MXC) URI (in the form of "mxc://...")
...
/**
 Download encrypted data from the SDN Content repository.
 
 @param encryptedContentFile the encrypted SDN Content details.
...
/**
 Prepares a media loader to upload data to a sdn content repository.
 ...
 @param mxSession the sdn session used to upload media.
...
/**
 Build a cache file path based on the SDN Content URI of the media and an optional cache folder.
 ...
 @param mimeType the media mime type (may be nil).
 @param folder cache folder to use (may be nil). kMXMediaManagerDefaultCacheFolder is used by default.
 @return cache file path. nil if the SDN Content URI is invalid.
 */
+ (NSString*)cachePathForSDNContentURI:(NSString*)mxContentURI
                                  andType:(NSString *)mimeType
                                 inFolder:(NSString*)folder;

/**
 Build a cache file path for a thumbnail downloaded from on the SDN Content URI.
