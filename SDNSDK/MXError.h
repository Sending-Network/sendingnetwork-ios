...
/**
 SDN error codes
 The error as described by the SDN standard (http://sdn.org/docs/spec/#api-standards).
 */
...
/**
 Keys and values that can be found in a SDN error JSON dictionary.
 */
...
/**
 Check if an NSError is in the SDN error domain
