...
/**
 ...
 SDN requests.
 The specification of these filters can be found at https://sdn.org/docs/spec/client_server/r0.3.0.html#filtering.
 */
...
/**
 ...
 This contructor allows to use filter fields that may not be yet in the SDN
 specification.
