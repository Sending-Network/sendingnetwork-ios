...
/// An implementation of `MXBackgroundCrypto` which uses [sdn-rust-sdk](https://github.com/sdn-org/sdn-rust-sdk/tree/main/crates/sdn-sdk-crypto)
/// under the hood.
class MXBackgroundCryptoV2: MXBackgroundCrypto {
    ...
    // See https://github.com/sdn-org/sdn-rust-sdk/issues/1415 for more details.
