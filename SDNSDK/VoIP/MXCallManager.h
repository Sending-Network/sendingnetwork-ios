...
/**
 Posted when a new turn servers response is received from the node.
 The notification object will be the call manager instance.
 */
...
/**
 The `MXCallManager` object manages calls for a given SDN session.
 It manages call signaling over SDN (@see http://sdn.org/docs/spec/#id9) and then opens
 ...
 */
- (instancetype)initWithSDNSession:(MXSession *)mxSession andCallStack:(id<MXCallStack>)callstack NS_DESIGNATED_INITIALIZER;
...
/**
 The list of TURN/STUN servers advertised by the user's node.
...
/**
 STUN server used if the node does not provide TURN/STUN servers.
 */
