...
// The HS domain part in SDN identifiers
#define MATRIX_NODE_DOMAIN_REGEX                            @"[A-Z0-9]+((\\.|\\-)[A-Z0-9]+){0,}(:[0-9]{2,5})?"

NSString *const kMXToolsRegexStringForSDNUserIdentifier      = @"@[\\x21-\\x39\\x3B-\\x7F]+:" MATRIX_NODE_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSDNRoomAlias           = @"#[A-Z0-9._%#@=+-]+:" MATRIX_NODE_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSDNRoomIdentifier      = @"![A-Z0-9]+:" MATRIX_NODE_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSDNEventIdentifier     = @"\\$[A-Z0-9]+:" MATRIX_NODE_DOMAIN_REGEX;
NSString *const kMXToolsRegexStringForSDNEventIdentifierV3   = @"\\$[A-Z0-9\\/+]+";
NSString *const kMXToolsRegexStringForSDNGroupIdentifier     = @"\\+[A-Z0-9=_\\-./]+:" MATRIX_NODE_DOMAIN_REGEX;
...
static NSRegularExpression *isSDNUserIdentifierRegex;
static NSRegularExpression *isSDNRoomAliasRegex;
static NSRegularExpression *isSDNRoomIdentifierRegex;
static NSRegularExpression *isSDNEventIdentifierRegex;
static NSRegularExpression *isSDNEventIdentifierV3Regex;
static NSRegularExpression *isSDNGroupIdentifierRegex;
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        isSDNUserIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNUserIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
        isSDNRoomAliasRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNRoomAlias]
                                                                           options:NSRegularExpressionCaseInsensitive error:nil];
        isSDNRoomIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNRoomIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
        isSDNEventIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNEventIdentifier]
                                                                                 options:NSRegularExpressionCaseInsensitive error:nil];
        isSDNEventIdentifierV3Regex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNEventIdentifierV3]
                                                                                 options:NSRegularExpressionCaseInsensitive error:nil];

        isSDNGroupIdentifierRegex = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithFormat:@"^%@$", kMXToolsRegexStringForSDNGroupIdentifier]
                                                                                options:NSRegularExpressionCaseInsensitive error:nil];
...
+ (BOOL)isSDNUserIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSDNUserIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSDNRoomAlias:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSDNRoomAliasRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSDNRoomIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSDNRoomIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSDNEventIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSDNEventIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)])
        || (nil != [isSDNEventIdentifierV3Regex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (BOOL)isSDNGroupIdentifier:(NSString *)inputString
{
    if (inputString)
    {
        return (nil != [isSDNGroupIdentifierRegex firstMatchInString:inputString options:0 range:NSMakeRange(0, inputString.length)]);
    }
    return NO;
}

+ (NSString*)serverNameInSDNIdentifier:(NSString *)identifier
{
...
+ (NSString *)permalinkToRoom:(NSString *)roomIdOrAlias
{
    ...
    NSString *baseUrl = clientBaseUrl != nil ? clientBaseUrl : kMXSDNDotToUrl;
