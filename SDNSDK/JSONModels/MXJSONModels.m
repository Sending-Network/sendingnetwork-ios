...
+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    if (loginResponse)
    {
        MXJSONModelSetString(loginResponse.node, JSONDictionary[@"home_server"]);
...
+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    MXJSONModelSetString(response.node, JSONDictionary[@"home_server"]);
...
+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    if (openIdToken)
    {
        ...
        MXJSONModelSetString(openIdToken.sdnServerName, JSONDictionary[@"sdn_server_name"]);
...
{
    // The dictionary sent by the node.
    NSDictionary *JSONDictionary;
}
@end
...
+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    ...
    if (versionCapabilities)
    {
        ...
        MXJSONModelSetDictionary(roomCapabilitiesData, JSONDictionary[@"org.sdn.msc3244.room_capabilities"]);
...
@implementation MXNodeCapabilities

+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    MXNodeCapabilities *capabilities = [MXNodeCapabilities new];
