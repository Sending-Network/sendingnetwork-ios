...
public extension MXIdentityService {
    ...
    /**
     ...
     - nodeRestClient: The node REST client.
     
     - returns: a `MXIdentityService` instance.
     */
    @nonobjc convenience init(identityServer: URL, accessToken: String?, nodeRestClient: MXRestClient) {
        self.init(__identityServer: identityServer.absoluteString, accessToken: accessToken, andNodeRestClient: nodeRestClient)
    }
