...
/**
 Optional. If specified, the transferee client waits for an invite to this room and joins it and then continues the transfer in this room. If absent, the transferee contacts the SDN User ID given in the `targetUser` field in a room of its choosing.
 */
