...
{
    MXWeakify(self);
    [self.mxSession.sdnRestClient setDisplayName:displayname success:^{
...
{
    MXWeakify(self);
    [_mxSession.sdnRestClient setAvatarUrl:avatarUrl success:^{
        MXStrongifyAndReturnIfNil(self);
...
{
    MXWeakify(self);
    [_mxSession.sdnRestClient setPresence:presence andStatusMessage:statusMessage success:^{
        MXStrongifyAndReturnIfNil(self);
