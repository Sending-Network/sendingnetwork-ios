...
/**
 The node .well-known.
 */
@property (nonatomic) MXWellKnown *nodeWellknown;

/**
 The node capabilities.
 */
@property (nonatomic) MXCapabilities *nodeCapabilities;

/**
 Supported SDN versions.
 */
@property (nonatomic) MXSDNVersions *supportedSDNVersions;
