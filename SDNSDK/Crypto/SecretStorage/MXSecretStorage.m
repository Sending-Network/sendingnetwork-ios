...
NSString *const MXSecretStorageErrorDomain = @"org.sdn.sdk.MXSecretStorage";
...
- (instancetype)initWithSDNSession:(MXSession *)mxSession processingQueue:(dispatch_queue_t)aProcessingQueue
{
    self = [super init];
    if (self)
    {
...
{
    // MSC2472(https://github.com/uhoreg/sdn-doc/blob/symmetric_ssss/proposals/2472-symmetric-ssss.md) says:
