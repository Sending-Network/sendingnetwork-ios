...
// Indicate if the key has been backed up to the node
    ...
    if (oldSchemaVersion < kMXRealmCryptoStoreVersion)
    {
        ...
        switch (oldSchemaVersion)
        {
            case 1:
            {
                ...
                // https://github.com/sdn-org/sdn-ios-sdk/issues/227
            ...
            case 8:
            {
                ...
                // https://github.com/Sending-Network/SendingnNetwork-ios/issues/2128
            ...
            case 11:
            {
                ...
                // Because of https://github.com/Sending-Network/SendingnNetwork-ios/issues/2896, algorithms were not stored
...
+ (void)cleanDuplicatedDevicesInRealm:(RLMRealm*)realm
{
    [realm transactionWithName:@"[MXRealmCryptoStore] cleanDuplicatedDevicesInRealm" block:^{
        ...
        // Due to a bug (https://github.com/Sending-Network/SendingnNetwork-ios/issues/2132), there were
