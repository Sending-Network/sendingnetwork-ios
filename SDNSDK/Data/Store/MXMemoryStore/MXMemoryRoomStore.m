...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        _hasReachedNodePaginationEnd = NO;
...
{
    return [NSString stringWithFormat:@"%tu messages - paginationToken: %@ - hasReachedNodePaginationEnd: %@ - hasLoadedAllRoomMembersForRoom: %@", messages.count, _paginationToken, @(_hasReachedNodePaginationEnd), @(_hasLoadedAllRoomMembersForRoom)];
}
