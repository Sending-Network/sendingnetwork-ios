...
/**
 ...
 It provides TURN server configuration advised by the node.
 */
@interface MXTurnServerResponse : MXJSONModel

/**
 The username of the SDN user on the TURN server.
 */
...
/**
 ...
 It is computed by the user's node when the request is made.
