...
/**
 Start getting room data from the node and keep sync'ed with it.
 
 Use [MXPeekingRoom close] to stop syncing with the node.
...
/**
 ...
 No more data is retrieved from the node.
*/
- (void)close;
