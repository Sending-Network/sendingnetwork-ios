...
extension MXSpaceServiceError: CustomNSError {
    public static let errorDomain = "org.sdn.sdk.spaceService"
...
public class MXSpaceService: NSObject {
    ...
    public init(session: MXSession) {
        ...
        self.processingQueue = DispatchQueue(label: "org.sdn.sdk.MXSpaceService.processingQueue", attributes: .concurrent)
        ...
        self.spacesPerIdReadWriteQueue = DispatchQueue(
          label: "org.sdn.sdk.MXSpaceService.spacesPerIdReadWriteQueue",
    ...
    public func getSpaceChildrenForSpace(withId spaceId: String,
        ...
        return self.session.sdnRestClient.getSpaceChildrenForSpace(withId: spaceId, suggestedOnly: suggestedOnly, limit: limit, maxDepth: maxDepth, paginationToken: paginationToken) { (response) in
            switch response {
    ...
    private class PrepareDataResult {
        ...
        private let serialQueue = DispatchQueue(label: "org.sdn.sdk.MXSpaceService.PrepareDataResult.serialQueue")
    ...
    private func createRoomSummary(with spaceChildSummaryResponse: MXSpaceChildSummaryResponse) -> MXRoomSummary {
        ...
        let roomSummary: MXRoomSummary = MXRoomSummary(roomId: roomId, andSDNSession: nil)
