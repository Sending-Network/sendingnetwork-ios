...
public extension MXEventTimeline {
    ...
    /**
     ...
     - parameters:
        ...
        - onlyFromStore: if true, return available events from the store, do not make a pagination request to the node.
        - completion: A block object called when the operation completes.
        - response: Indicates whether the operation succeeded or failed.
     
     - returns: a MXHTTPOperation instance. This instance can be nil if no request to the node is required.
     */
