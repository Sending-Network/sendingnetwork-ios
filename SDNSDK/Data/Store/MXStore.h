...
/**
 ...
 SDN data handled during a `MXSession`.
 */
 ...
 */
// @TODO(summary): Move to MXRoomSummary
- (void)storeHasReachedNodePaginationEndForRoom:(nonnull NSString*)roomId andValue:(BOOL)value;
- (BOOL)hasReachedNodePaginationEndForRoom:(nonnull NSString*)roomId;
...
/**
 Get the list of all stored sdn users.
...
/**
 Get the list of all stored sdn groups.
...
/**
 Retrieve the node .well-known data.
 */
@property (nonatomic, readonly) MXWellKnown * _Nullable nodeWellknown;

/**
 Store the node .well-known data.

 @param nodeWellknown the .well-known data to store.
 */
 ...
 */
@property (nonatomic, readonly) MXCapabilities * _Nullable nodeCapabilities;

/**
 Store the node capabilities.

 @param nodeCapabilities the node capabilities to store.
 */
- (void)storeNodeCapabilities:(nonnull MXCapabilities*)nodeCapabilities;

/**
 Supported SDN versions by the node.
 */
@property (nonatomic, readonly) MXSDNVersions * _Nullable supportedSDNVersions;

/**
 Store the supported SDN versions.

 @param supportedSDNVersions the supported SDN versions to store.
 */
- (void)storeSupportedSDNVersions:(nonnull MXSDNVersions*)supportedSDNVersions;
...
/**
 Store/retrieve the id of the SDN filter used in /sync requests.
 */
...
/**
 ...
 @param filterId the id of this filter on the node.
 */
