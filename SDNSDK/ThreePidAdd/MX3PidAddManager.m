...
NSString *const MX3PidAddManagerErrorDomain = @"org.sdn.sdk.MX3PidAddManagerErrorDomain";
...
- (instancetype)initWithSDNSession:(MXSession *)session
{
    self = [super init];
    if (self)
    {
                                                    ...
                                                    failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    return [self->mxSession.sdnRestClient add3PIDOnlyWithSessionId:@"" clientSecret:[MXTools generateSecret] authParams:nil success:^{
                                           ...
                                           failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    threePidAddSession.httpOperation = [self checkIdentityServerRequirementForAdding3PidWithSuccess:^{
        ...
        MXHTTPOperation *operation = [self->mxSession.sdnRestClient requestTokenForEmail:email isDuringRegistration:NO clientSecret:threePidAddSession.clientSecret sendAttempt:threePidAddSession.sendAttempt++ nextLink:nextLink success:^(NSString *sid) {
                           ...
                           failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    if (doesServerSupportSeparateAddAndBind)
    {
        ...
        threePidAddSession.httpOperation = [mxSession.sdnRestClient add3PIDOnlyWithSessionId:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret authParams:authParams success:^{
    ...
    else
    {
        ...
        threePidAddSession.httpOperation = [mxSession.sdnRestClient add3PID:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret bind:NO success:^{
            threePidAddSession.httpOperation = nil;
                                                       ...
                                                       failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    threePidAddSession.httpOperation = [self checkIdentityServerRequirementForAdding3PidWithSuccess:^{
        ...
        MXHTTPOperation *operation = [self->mxSession.sdnRestClient requestTokenForPhoneNumber:phoneNumber isDuringRegistration:NO countryCode:countryCode clientSecret:threePidAddSession.clientSecret sendAttempt:threePidAddSession.sendAttempt++ nextLink:nil success:^(NSString *sid, NSString *msisdn, NSString *submitUrl) {
                              ...
                              failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    threePidAddSession.httpOperation = [self submitValidationToken:token for3PidAddSession:threePidAddSession success:^{
        ...
        {
            // https://gist.github.com/jryans/839a09bf0c5a70e2f36ed990d50ed928#2b-adding-a-3pid-to-hs-account-after-registration-post-msc2290
            operation = [self->mxSession.sdnRestClient add3PIDOnlyWithSessionId:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret authParams:authParams success:^{
        ...
        {
            // https://gist.github.com/jryans/839a09bf0c5a70e2f36ed990d50ed928#2a-adding-a-3pid-to-hs-account-after-registration-pre-msc2290
            operation = [self->mxSession.sdnRestClient add3PID:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret bind:NO success:^{
                                      ...
                                      failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    if (doesServerSupportSeparateAddAndBind)
    {
        [self tryFinaliseIdentityServer3PidSessionWithNewNode:threePidAddSession withToken:nil success:success failure:failure];
    }
    else
    {
        [self tryFinaliseIdentityServer3PidSessionWithOldNode:threePidAddSession withToken:nil success:success failure:failure];
    }
}
                                         ...
                                         failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    if (doesServerSupportSeparateAddAndBind)
    {
        [self tryFinaliseIdentityServer3PidSessionWithNewNode:threePidAddSession withToken:token success:success failure:failure];
    }
    else
    {
        [self tryFinaliseIdentityServer3PidSessionWithOldNode:threePidAddSession withToken:token success:success failure:failure];
    }
}
...
{
    MXWeakify(self);
    return [mxSession.sdnRestClient supportedSDNVersions:^(MXSDNVersions *sdnVersions) {
        MXStrongifyAndReturnIfNil(self);

        MXLogDebug(@"[MX3PidAddManager] checkIdentityServerRequirement: %@", sdnVersions.doesServerRequireIdentityServerParam ? @"YES": @"NO");

        MXLogDebug(@"[MX3PidAddManager] doesServerSupportSeparateAddAndBind: %@", sdnVersions.doesServerSupportSeparateAddAndBind ? @"YES": @"NO");
        self->doesServerSupportSeparateAddAndBind = sdnVersions.doesServerSupportSeparateAddAndBind;

        if (sdnVersions.doesServerRequireIdentityServerParam
            && !self->mxSession.sdnRestClient.identityServer)
        {
            NSError *error = [NSError errorWithDomain:MX3PidAddManagerErrorDomain
                                                 ...
                                                 failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    else
    {
        ...
        operation = [mxSession.identityService accessTokenWithSuccess:^(NSString * _Nullable accessToken) {
            ...
            if (accessToken)
            {
                MXHTTPOperation *operation2 = [self->mxSession.sdnRestClient supportedSDNVersions:^(MXSDNVersions *sdnVersions) {
...
/**
 ...
 `[MXRestClient requestTokenForPhoneNumber:]`). The node response may
...
- (NSDictionary*)authParamsFromError:(NSError*)error andPassword:(nullable NSString*)password
{
    ...
    if (urlResponse && urlResponse.statusCode == 401)
    {
        ...
        {
            NSString *userId = self->mxSession.sdnRestClient.credentials.userId;
            authParams = @{
                     ...
                     failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    threePidAddSession.httpOperation = [self doesServerSupportSeparateAddAndBind:^(BOOL doesServerSupportSeparateAddAndBind) {
        ...
        if (doesServerSupportSeparateAddAndBind)
        {
            ...
            {
                operation = [self startIdentityServer3PidSessionWithNewNode:threePidAddSession success:^{
                    threePidAddSession.httpOperation = nil;
                    success(YES);
                } failure:^(NSError *error) {
                    threePidAddSession.httpOperation = nil;
            ...
            else
            {
                ...
                operation = [self->mxSession.sdnRestClient unbind3PidWithAddress:threePidAddSession.address medium:threePidAddSession.medium success:^{
        ...
        {
            operation = [self startBind3PidSessionWithOldNode:threePidAddSession success:^{
                threePidAddSession.httpOperation = nil;
                success(YES);
            } failure:^(NSError *error) {
                threePidAddSession.httpOperation = nil;
...
- (MXHTTPOperation *)startIdentityServer3PidSessionWithNewNode:(MX3PidAddSession*)threePidAddSession
                                                             success:(void (^)(void))success
                                                             failure:(void (^)(NSError * _Nonnull))failure
{
    ...
    if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumEmail])
    {
        operation = [identityService requestEmailValidation:threePidAddSession.address clientSecret:threePidAddSession.clientSecret sendAttempt:threePidAddSession.sendAttempt++ nextLink:nil success:^(NSString * _Nonnull sid) {
            ...
            MXLogDebug(@"[MX3PidAddManager] startIdentityServer3PidSessionWithNewNode: DONE: threePid: %@", threePidAddSession);

            threePidAddSession.sid = sid;
            success();

        } failure:^(NSError *error) {
            MXLogDebug(@"[MX3PidAddManager] startIdentityServer3PidSessionWithNewNode: threePid: %@. ERROR: requestTokenForEmail failed: %@", threePidAddSession, error);
            failure(error);
        }];
    }
    else
...
- (void)tryFinaliseIdentityServer3PidSessionWithNewNode:(MX3PidAddSession*)threePidAddSession
                                                    withToken:(nullable NSString*)token
                                                      success:(void (^)(void))success
                                                      failure:(void (^)(NSError * _Nonnull))failure
{
    MXLogDebug(@"[MX3PidAddManager] tryFinaliseIdentityServer3PidSessionWithNewNode: threePid: %@", threePidAddSession);
    ...
    if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumEmail])
    {
        threePidAddSession.httpOperation = [mxSession.sdnRestClient bind3PidWithSessionId:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret success:^{

            threePidAddSession.httpOperation = nil;

            MXLogDebug(@"[MX3PidAddManager] tryFinaliseIdentityServer3PidSessionWithNewNode: DONE: threePid: %@", threePidAddSession);
            success();
    ...
    else if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumMSISDN])
    {
        ...
        threePidAddSession.httpOperation = [self submitValidationToken:token for3PidAddSession:threePidAddSession success:^{
            ...
            MXHTTPOperation *operation = [self->mxSession.sdnRestClient bind3PidWithSessionId:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret success:^{
...
- (MXHTTPOperation *)startBind3PidSessionWithOldNode:(MX3PidAddSession*)threePidAddSession
                                                   success:(void (^)(void))success
                                                   failure:(void (^)(NSError * _Nonnull))failure
{
    MXLogDebug(@"[MX3PidAddManager] startBind3PidSessionWithOldNode: threePid: %@", threePidAddSession);

    MXWeakify(self);
    MXHTTPOperation *operation;
    operation = [mxSession.sdnRestClient remove3PID:threePidAddSession.address medium:threePidAddSession.medium success:^{
        MXStrongifyAndReturnIfNil(self);

        MXHTTPOperation *operation2;
        if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumEmail])
        {
            operation2 = [self->mxSession.sdnRestClient requestTokenForEmail:threePidAddSession.address isDuringRegistration:NO clientSecret:threePidAddSession.clientSecret sendAttempt:threePidAddSession.sendAttempt++ nextLink:nil success:^(NSString *sid) {

                MXLogDebug(@"[MX3PidAddManager] startBind3PidSessionWithOldNode: DONE: threePid: %@", threePidAddSession);

                threePidAddSession.sid = sid;
                success();

            } failure:^(NSError *error) {
                MXLogDebug(@"[MX3PidAddManager] startBind3PidSessionWithOldNode: threePid: %@. ERROR: requestTokenForEmail failed: %@", threePidAddSession, error);
                failure(error);
            }];
        }
        else
        {
            operation2 = [self->mxSession.sdnRestClient requestTokenForPhoneNumber:threePidAddSession.address isDuringRegistration:NO countryCode:threePidAddSession.countryCode clientSecret:threePidAddSession.clientSecret sendAttempt:threePidAddSession.sendAttempt++ nextLink:nil success:^(NSString *sid, NSString *msisdn, NSString *submitUrl) {
        ...
        MXLogDebug(@"[MX3PidAddManager] startBind3PidSessionWithOldNode: threePid: %@. ERROR: remove3PID failed: %@", threePidAddSession, error);
        failure(error);
    }];
...
- (void)tryFinaliseIdentityServer3PidSessionWithOldNode:(MX3PidAddSession*)threePidAddSession
                                                    withToken:(nullable NSString*)token
                                                      success:(void (^)(void))success
                                                      failure:(void (^)(NSError * _Nonnull))failure
{
    MXLogDebug(@"[MX3PidAddManager] tryFinaliseIdentityServer3PidSessionWithOldNode: threePid: %@", threePidAddSession);
    ...
    if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumEmail])
    {
        threePidAddSession.httpOperation = [mxSession.sdnRestClient add3PID:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret bind:threePidAddSession.bind success:^{
            threePidAddSession.httpOperation = nil;

            MXLogDebug(@"[MX3PidAddManager] tryFinaliseIdentityServer3PidSessionWithOldNode: DONE: threePid: %@", threePidAddSession);
            success();
    ...
    else if ([threePidAddSession.medium isEqualToString:kMX3PIDMediumMSISDN])
    {
        ...
        threePidAddSession.httpOperation = [self submitValidationToken:token for3PidAddSession:threePidAddSession success:^{
            ...
            MXHTTPOperation *operation = [self->mxSession.sdnRestClient add3PID:threePidAddSession.sid clientSecret:threePidAddSession.clientSecret bind:threePidAddSession.bind success:^{
