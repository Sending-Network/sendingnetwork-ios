...
/**
 Maximum number of keys to send at a time to the node.
 */
                                    ...
                                    failure:(void (^)(NSError *))failure
{
    ...
    NSString *myUserId = self.crypto.sdnRestClient.credentials.userId;
                      ...
                      failure:(void (^)(NSError *))failure
{
    ...
    // Gather data to send to the node
    ...
    // Make the request
    MXWeakify(self);
    [self.crypto.sdnRestClient sendKeysBackup:keysBackupData version:self.keyBackupVersion.version success:^(NSDictionary *JSONResponse){
