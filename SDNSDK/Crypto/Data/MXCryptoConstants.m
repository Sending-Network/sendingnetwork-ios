...
NSString *const kMXCryptoAes256KeyBackupAlgorithm       = @"org.sdn.msc3270.v1.aes-hmac-sha2";
NSString *const MXCryptoOlmPickleKeyDataType            = @"org.sdn.sdk.olm.pickle.key";
NSString *const MXCryptoSDKStoreKeyDataType             = @"org.sdn.sdk.crypto.store.key";


#pragma mark - Encrypting error

NSString *const MXEncryptingErrorDomain = @"org.sdn.sdk.encryption";
