...
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSDNUserIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSDNRoomAlias;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSDNRoomIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSDNEventIdentifier;
FOUNDATION_EXPORT NSString *const kMXToolsRegexStringForSDNGroupIdentifier;
...
/**
 Check whether a string is formatted as a sdn user identifier.
 
 @return YES if the provided string is formatted as a sdn user id.
 */
+ (BOOL)isSDNUserIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sdn room alias.
 
 @return YES if the provided string is formatted as a sdn room alias.
 */
+ (BOOL)isSDNRoomAlias:(NSString *)inputString;

/**
 Check whether a string is formatted as a sdn room identifier.
 
 @return YES if the provided string is formatted as a sdn room identifier.
 */
+ (BOOL)isSDNRoomIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sdn event identifier.

 @return YES if the provided string is formatted as a sdn event identifier.
 */
+ (BOOL)isSDNEventIdentifier:(NSString *)inputString;

/**
 Check whether a string is formatted as a sdn group identifier.
 
 @return YES if the provided string is formatted as a sdn group identifier.
 */
+ (BOOL)isSDNGroupIdentifier:(NSString *)inputString;

/**
 Extract the server name part of a sdn identifier.

 For example, this methods returns "sdn.org" from "!anEvent:sdn.org"

 @param identifier a SDN identifier.
...
/*
 ...
 The permalink could be sdn.to format or a custom client permalink (see `MXSDKOptions.clientPermalinkBaseUrl`).
