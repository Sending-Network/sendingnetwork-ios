...
/**
 Initialise a media loader to upload data to a sdn content repository.
 ...
 */
- (id)initForUploadWithSDNSession:(MXSession*)mxSession initialRange:(CGFloat)anInitialRange andRange:(CGFloat)aRange;
