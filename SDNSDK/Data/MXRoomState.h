...
/**
 ...
 @param sdnSession the session to the home server. It is used to get information about the user
...
/**
 ...
 @param roomId the room id to the room.
 @param sdnSession the mxSession to the home server. It is used to get information about the user
                  currently connected to the home server.
...
/**
 ...
 When invited by a 3pid medium like email, the not-yet-registered-to-sdn user is indicated
 in the room state by a m.room.third_party_invite event.
 Once he registers, the node adds a m.room.membership event to the room state.
