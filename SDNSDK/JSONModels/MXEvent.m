...
NSString *const kMXEventTypeStringCallAssertedIdentityUnstable  = @"org.sdn.call.asserted_identity";
...
NSString *const kMXEventTypeStringSpaceOrderMSC3230     = @"org.sdn.msc3230.space_order";
...
NSString *const kMXEventTypeStringPollStartMSC3381    = @"org.sdn.msc3381.poll.start";
NSString *const kMXEventTypeStringPollResponse        = @"m.poll.response";
NSString *const kMXEventTypeStringPollResponseMSC3381 = @"org.sdn.msc3381.poll.response";
NSString *const kMXEventTypeStringPollEnd             = @"m.poll.end";
NSString *const kMXEventTypeStringPollEndMSC3381      = @"org.sdn.msc3381.poll.end";

NSString *const kMXEventTypeStringBeaconInfo = @"m.beacon_info";
NSString *const kMXEventTypeStringBeaconInfoMSC3672 = @"org.sdn.msc3672.beacon_info";
NSString *const kMXEventTypeStringBeacon = @"m.beacon";
NSString *const kMXEventTypeStringBeaconMSC3672 = @"org.sdn.msc3672.beacon";
...
//  https://github.com/sdn-org/sdn-doc/pull/3440
NSString *const MXEventRelationTypeThread            = @"m.thread";

NSString *const kMXToDeviceMessageId                 = @"org.sdn.msgid";
...
NSString *const kMXMessageContentKeyVoiceMessageMSC2516 = @"org.sdn.msc2516.voice";
NSString *const kMXMessageContentKeyVoiceMessageMSC3245 = @"org.sdn.msc3245.voice";

NSString *const kMXMessageContentKeyExtensibleAudio = @"m.audio";
NSString *const kMXMessageContentKeyExtensibleAudioMSC1767 = @"org.sdn.msc1767.audio";
...
NSString *const kMXMessageContentKeyExtensibleTextMSC1767 = @"org.sdn.msc1767.text";

NSString *const kMXMessageContentKeyExtensibleTimestamp = @"m.ts";
NSString *const kMXMessageContentKeyExtensibleTimestampMSC3488 = @"org.sdn.msc3488.ts";

NSString *const kMXMessageContentKeyExtensibleFile = @"m.file";
NSString *const kMXMessageContentKeyExtensibleFileMSC1767 = @"org.sdn.msc1767.file";
...
NSString *const kMXMessageContentKeyExtensiblePollStartMSC3381 = @"org.sdn.msc3381.poll.start";

NSString *const kMXMessageContentKeyExtensiblePollResponse = @"m.poll.response";
NSString *const kMXMessageContentKeyExtensiblePollResponseMSC3381 = @"org.sdn.msc3381.poll.response";

NSString *const kMXMessageContentKeyExtensiblePollEnd = @"m.poll.end";
NSString *const kMXMessageContentKeyExtensiblePollEndMSC3381 = @"org.sdn.msc3381.poll.end";
...
NSString *const kMXMessageContentKeyExtensiblePollKindDisclosedMSC3381 = @"org.sdn.msc3381.poll.disclosed";
NSString *const kMXMessageContentKeyExtensiblePollKindDisclosed = @"m.poll.disclosed";
NSString *const kMXMessageContentKeyExtensiblePollKindUndisclosedMSC3381 = @"org.sdn.msc3381.poll.undisclosed";
...
NSString *const kMXMessageContentKeyExtensibleLocationMSC3488 = @"org.sdn.msc3488.location";
...
NSString *const kMXMessageContentKeyExtensibleAssetMSC3488 = @"org.sdn.msc3488.asset";
...
/**
 Finalise the parsing of a SDN event.
 */
- (void)finalise
{
