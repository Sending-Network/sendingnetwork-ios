...
/**
 Room visibility in the node directory.
 */
...
NSString *const kMXRoomMessageFormatHTML = @"org.sdn.custom.html";

NSString *const kMXSDNDotToUrl = @"https://sdn.to";
