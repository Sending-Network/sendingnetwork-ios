...
- (void)processReceivedRoomKeyRequest:(MXIncomingRoomKeyRequest*)req
{
    ...
    if (![userId isEqualToString:crypto.sdnRestClient.credentials.userId])
    {
...
- (void)fixMissingUser:(NSString *)userId inRoom:(NSString *)roomId
{
    ...
    // This is a workaround for https://github.com/Sending-Network/sendingnetwork-ios/issues/3807
