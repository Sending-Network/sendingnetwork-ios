...
/**
 Service to manage backup of private keys on the node.
 */
...
/**
 ...
 Device keys will be uploaded, then one time keys if there are not enough on the node.
...
/**
 ...
 Keys will be downloaded from the sdn node and stored into the crypto store
...
/**
 The secret storage on node manager.
 */
