...
@objcMembers public class MXBackgroundPushRulesManager: NSObject {
    ...
    public init(withCredentials credentials: MXCredentials) {
        ...
        memberCountConditionChecker = MXPushRuleRoomMemberCountConditionChecker(sdnSession: nil)
        permissionConditionChecker = MXPushRuleSenderNotificationPermissionConditionChecker(sdnSession: nil)
        super.init()
    }
    ...
    public func pushRule(matching event: MXEvent,
        ...
        let displayNameChecker = MXPushRuleDisplayNameCondtionChecker(sdnSession: nil,
