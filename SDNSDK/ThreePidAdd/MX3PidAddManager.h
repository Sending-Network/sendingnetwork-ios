...
/**
  ...
  to their node and, optionally, the identity servers (bind).
...
- (instancetype)initWithSDNSession:(MXSession*)session NS_REFINED_FOR_SWIFT;
...
/**
 Get the authentication flow required to add a 3rd party id to the user node account.
...
/**
 Add an email to the user node account.
...
/**
 Add a phone number to the user node account.
