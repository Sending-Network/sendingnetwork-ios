...
/// See MSC3672 for more details https://github.com/sdn-org/sdn-spec-proposals/blob/stefan/ephemeral-location-streaming/proposals/3672-ephemeral-location-streaming.md
...
/// Create the `MXBeacon` object from a SDN m.beacon event.
