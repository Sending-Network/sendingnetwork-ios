...
/**
 Scheme used in SDN content URIs.
 */
FOUNDATION_EXPORT NSString *const kMXContentUriScheme;
/**
 A constant representing the default prefix of the SDN content repository path.
 */
...
/**
 Methods of thumnailing supported by the SDN content repository.
 */
...
/**
 Room visibility in the current node directory.
 The default node value is private.
 */
typedef NSString* MXRoomDirectoryVisibility NS_REFINED_FOR_SWIFT;

/**
 The room is not listed in the node directory.
 */
FOUNDATION_EXPORT NSString *const kMXRoomDirectoryVisibilityPrivate;

/**
 The room is listed in the node directory.
 */
...
/**
 ...
 joined.
 The default node value is shared.
 */
...
/**
 ...
 participating node with anyone, regardless of whether they have ever joined
 the room.
 */
...
/**
 Room join rule.
 The default node value is invite.
 */
...
/**
 Reserved keywords which are not implemented by nodes.
 */
...
/**
 Room guest access.
 The default node value is forbidden.
 */
...
/**
 Format for room message event with a "formatted_body" using the "org.sdn.custom.html" format.
 */
