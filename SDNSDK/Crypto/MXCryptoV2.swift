...
/// An implementation of `MXCrypto` which uses [sdn-rust-sdk](https://github.com/sdn-org/sdn-rust-sdk/tree/main/crates/sdn-sdk-crypto)
/// under the hood.
class MXCryptoV2: NSObject, MXCrypto {
    ...
    init(
        ...
        let legacyQueue = DispatchQueue(label: "org.sdn.sdk.MXCryptoV2")
