...
/**
 ...
 @param url the node url (ex: "https://sdn.org").
...
/**
 ...
 @param domain  node domain (ex: "sdn.org" from userId "@user:sdn.org").
 @return a `MXAutoDiscovery` instance.
 */
...
/**
 ...
 - validate node url and identity server url if provide in .well-known result
...
/**
 Get the wellknown data of the node.
