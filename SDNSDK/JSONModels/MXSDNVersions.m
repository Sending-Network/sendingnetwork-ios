...
const struct MXSDNClientServerAPIVersionStruct MXSDNClientServerAPIVersion = {
    .r0_0_1 = @"r0.0.1",
    .r0_1_0 = @"r0.1.0",
    .r0_2_0 = @"r0.2.0",
    .r0_3_0 = @"r0.3.0",
...
const struct MXSDNVersionsFeatureStruct MXSDNVersionsFeature = {
...
//  Unstable features
static NSString* const kJSONKeyMSC3440 = @"org.sdn.msc3440.stable";
static NSString* const kJSONKeyMSC3881Unstable = @"org.sdn.msc3881";
static NSString* const kJSONKeyMSC3881 = @"org.sdn.msc3881.stable";
static NSString* const kJSONKeyMSC3882 = @"org.sdn.msc3882";
static NSString* const kJSONKeyMSC3773 = @"org.sdn.msc3773";
static NSString* const kJSONKeyMSC3912Unstable = @"org.sdn.msc3912";
static NSString* const kJSONKeyMSC3912 = @"org.sdn.msc3912.stable";

@interface MXSDNVersions ()
...
@implementation MXSDNVersions

+ (id)modelFromJSON:(NSDictionary *)JSONDictionary
{
    if (JSONDictionary[kJSONKeyVersions])
    {
        MXSDNVersions *result = [MXSDNVersions new];
...
{
    return [self serverSupportsVersion:MXSDNClientServerAPIVersion.r0_5_0]
    || [self serverSupportsFeature:MXSDNVersionsFeature.lazyLoadMembers];
}

- (BOOL)doesServerRequireIdentityServerParam
{
    if ([self serverSupportsVersion:MXSDNClientServerAPIVersion.r0_6_0])
    {
        return NO;
    }

    return [self serverSupportsFeature:MXSDNVersionsFeature.requireIdentityServer
                          defaultValue:YES];
}

- (BOOL)doesServerAcceptIdentityAccessToken
{
    return [self serverSupportsVersion:MXSDNClientServerAPIVersion.r0_6_0]
    || [self serverSupportsFeature:MXSDNVersionsFeature.idAccessToken];
}

- (BOOL)doesServerSupportSeparateAddAndBind
{
    return [self serverSupportsVersion:MXSDNClientServerAPIVersion.r0_6_0]
    || [self serverSupportsFeature:MXSDNVersionsFeature.separateAddAndBind];
}
